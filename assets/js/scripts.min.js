(function (factory) {
	...
	jquery(document).ready(function () {
	  const $hamburger = jquery('.header-navigation__hamburger');
	  const $mobile_overlay = jquery('.mobile-overlay');
	...
	window.jQuery = jquery;
	jquery(document).ready(function () {
	  const sliderDestkop = jquery('.home_slider--init.desktop');
	  const sliderMobile = jquery('.home_slider--init.mobile'); // if (window.matchMedia("(orientation: portrait)").matches) {
